      ...
      // SystemManager
      {
        ...
        routes: [
          ...
          },
          {
            ...
            name: '菜单管理',
            //authority: ['admin'],
            component: './SystemManager/MenuManager',
          },
          {
          ...
          },
          {
            ...
            name: '定时任务',
            //authority: ['admin'],
            component: './SystemManager/TimingManager',
          },
          {
            path: '/system-manager/parameter-manager',
            name: '参数管理',
            //authority: ['admin'],
            component: './SystemManager/ParameterManager',
          },
          {
            path: '/system-manager/file-upload',
            name: '文件上传',
            //authority: ['admin'],
            component: './SystemManager/FileUpload',
          },
          {
            path: '/system-manager/dictionary-manager',
            name: '字典管理',
            //authority: ['admin'],
            component: './SystemManager/DictionaryManager',
          },
          {
